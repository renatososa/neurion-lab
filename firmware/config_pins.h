...
static const uint32_t FS_ADC_HZ         = 1000;  // muestreo interno ADS
static const uint32_t FS_OUTPUT_HZ      = 1000;  // muestreo enviado
// Diezmado automático: debe ser exacto FS_ADC_HZ / FS_OUTPUT_HZ
static const uint8_t  DECIMATION_FACTOR = FS_ADC_HZ / FS_OUTPUT_HZ;
